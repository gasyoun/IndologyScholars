...
## 1. Artem Novikov — 2013-06-14 16:30:03

Написал Thomas Malten'у по поводу расшарить базу, получил ответ:
...
*As soon as the data is prepared for download, it will be released.
It will take some time as we are at the moment busy with preparing other 
dictionaries for download. Please watch the download area.*
...
