...
> Рабочий драфт для ППВ. Версия 0.4, 2026-05-21. Целевой объем 12–15 стр., итоговое
> назначение — раздел «Научная жизнь» либо обзорно-аналитическая статья. В версии 0.4
> добавлены проверки дополнительных гипотез и публикационные рисунки.
...
![Рис. 2. Обновление состава: новички, ядро и повторные участники](figures/participant_dynamics.svg)

Рис. 2 показывает, что резкие колебания доли новичков возникают не только в кризисные
...
режим публикации программы и степень полноты источника.
...
![Рис. 4. Покрытие годом рождения зависит от частоты участия](figures/birth_year_coverage.svg)
...
![Рис. 3. Тематическая матрица L1 × L2](figures/theme_heatmap_l1_l2.svg)
...
![Рис. 1. Перекрестная когорта: баланс участия на двух площадках](figures/cross_cohort_balance.svg)
...
2. **Метрики закрытости описательно поддерживают это различие**: доля ядра в
   ...
   дебютантов выше на 13%, доля разовых участников ниже на 15%. При этом эти
