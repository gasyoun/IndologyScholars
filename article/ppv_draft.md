...
когорту, которой посвящен раздел 9. В отсутствие независимого базового ожидания эту долю
нельзя напрямую трактовать как меру «изоляции»; содержательно важно другое: две
дисциплинарно родственные площадки в одной стране образуют два частично
непересекающихся круга.
