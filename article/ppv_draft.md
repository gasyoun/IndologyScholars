...
![Рис. 1. Обновление состава: новички, ретроспективное ядро и повторные участники](https://github.com/gasyoun/IndologyScholars/blob/main/article/figures/participant_dynamics.svg)
...
![Рис. 2. Покрытие годом рождения является полным по всем частотным группам](https://github.com/gasyoun/IndologyScholars/blob/main/article/figures/birth_year_coverage.svg)
...
![Рис. 3. Возраст первого наблюдаемого выступления в корпусе](https://github.com/gasyoun/IndologyScholars/blob/main/article/hypothesis_output/age_at_debut.svg)
...
![Рис. 4. Тематическая матрица L1 × L2](https://github.com/gasyoun/IndologyScholars/blob/main/article/figures/theme_heatmap_l1_l2.svg)
...
![Рис. 5. Перекрестная когорта: баланс участия на двух площадках](https://github.com/gasyoun/IndologyScholars/blob/main/article/figures/cross_cohort_balance.svg)
...
![Рис. 6. Сессионная центральность участников по совместным сессиям](https://github.com/gasyoun/IndologyScholars/blob/main/article/hypothesis_output/network_bridges_session.svg)
...
### 9.1. Срезы 2026 г.: со-доклады, multi-layer centrality, мобильность, тематическая эволюция

К перекрёстной когорте и сессионной центральности корпус 2026 г. добавляет
пересчитываемые экспорты (H2367, H2411, H2416). Истинное со-докладчество
остаётся редким: 26 рёбер `person_person_copresentation` и 18 ненаправленных
коллаборационных пар после свёртки многолетних пар — при >99% одноавторских
докладов. Betweenness на сессионном слое (≈3091 рёбер) и событийной проекции
(≈10911) не смешиваются с коллаборацией; top-списки (Рыжакова, Цветкова,
Васильков; Тавастшерна, Корнеева, …) читаются как структурная связность, не
как «качество». Dual-series мосты (41) совпадают по численности с
перекрёстной когортой. Multi-city участники — 8 из 268 (3.0%), смена строки
аффилиации — 27 (10.1%); retention регионов/зарубежья (39.1%) ниже Москвы
(64.7%) и СПб (67.5%). Погодовая meso-эволюция (`theme_share_by_year.csv`)
показывает устойчивость буддийского и философско-эпистемологического контуров
при росте абсолютных объёмов и усиление контура «истории индологии» в
2020–2026 гг. Полные таблицы и рецепты — в `docs/NETWORK_*` и
`docs/GEOGRAPHIC_MOBILITY_*`; компактная journal-версия — в
`ppv_submission_article.md` §6.
...
![Рис. Г1. Нулевое распределение числа учёных на обеих площадках](https://github.com/gasyoun/IndologyScholars/blob/main/article/hypothesis_output/null_model_overlap.svg)
...
![Рис. Г2. Кривые дожития: доля учёных, ещё активных через N лет после дебюта](https://github.com/gasyoun/IndologyScholars/blob/main/article/hypothesis_output/km_retention.svg)
