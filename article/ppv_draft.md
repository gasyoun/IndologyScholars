<!-- УДК — основной кандидат; редакция ППВ обычно уточняет. Альтернативы:
     061.3:94(540) — конференции : история Индии;
     001.32(470)   — научные учреждения России;
     811.21:001.89 — индоарийские языки : организация науки;
     930.85(=214.21) — культурная история индоариев. -->
> **Редакционная пауза, 24.05.2026.** После восстановления ранее пропущенных
> строк официальных программ текущая база содержит **286 участников, 1350
> уникальных докладов и 1377 авторских участий** за **22 программных года**.
> Численные результаты этой расширенной рабочей версии требуют повторного
> расчета перед использованием в публикации.
> Сверенные текущие показатели вынесены в `ppv_submission_article.md`,
> `article/hypothesis_output/` и на страницу `findings/`; ниже в рабочем
> драфте сохраняются отдельные архивные разделы старого расчетного слоя.
...
**М. Ю. Гасунс** — независимый исследователь, Москва, Россия.
E-mail: gasyoun@gmail.com. ORCID: \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ *(заполнить перед подачей)*.

**M. Yu. Gasūns** — independent researcher, Moscow, Russia.

> Рабочий драфт для ППВ. Версия 0.7, 2026-05-24. Целевой объем 12–15 стр., итоговое
...
> интерпретация метрик закрытости и подписи публикационных рисунков; в версии 0.7
> синхронизированы базовые числа статьи с сайтом и текущей БД, а также формализованы
> дополнительные гипотезы Н11--Н35.
...
На основе нормализованного корпуса из 895 включенных в базу докладов и 220 ученых
...
плотное ядро (31.9% против 24.0% в Зографе; без предварительной программы 2026 г. —
25.7% в Зографе) и более высокую тематическую концентрацию
...
database of 895 catalogued talks and 220 scholars, including 837 talks through 2025
...
(31.9% vs 24.0%; 25.7% for Zograf when the preliminary 2026 programme is excluded)
...
конференциях, по нашим данным, в корпус вошли **220 уникальных ученых и 895
...
- **220 уникальных ученых** после нормализации;
...
Принципиальные ограничения. **Во-первых,** хотя в архивной базе полностью восстановлены биографические годы рождения для всех 220 уникальных участников (что устраняет селективные смещения выборки, см. раздел 7), мы по-прежнему ограничены источниковедческими факторами. **Во-вторых,** программы
...
Отдельно следует различать опубликованную программу и фактически состоявшийся ход
заседания. Программа фиксирует заявленное административное состояние расписания на
момент публикации, но не гарантирует, что каждый доклад был прочитан именно в
указанном формате и порядке. На практике возможны переход очного доклада в
онлайн-режим, перестановка выступлений внутри секции, отмена доклада или неявка
докладчика; при этом публичная программа после события может не обновляться. Поэтому
записи корпуса в настоящей статье трактуются как данные о публичной программной
видимости, а не как самостоятельное доказательство фактического присутствия,
прослушивания или рецепции доклада. Такие утверждения требуют дополнительной
верификации по видеозаписям, расписаниям дня, свидетельствам участников или
...
В корпус за период 2004–2026 гг. включены **895 докладов** и **220 ученых**: 837
...
зафиксировано 167 ученых с 540 докладами, на Рериховских за 18 событийных записей
(13 с извлеченными докладами) — 91 ученый с 355 докладами.
...
Из совокупных 220 ученых **38 (17.3%) выступали на обеих площадках**, образуя пересекающуюся
...
их лишь 38 — более чем на восемнадцать стандартных отклонений ниже ожидаемого. Иными
...
| Разовые участники, % | 43.7 | 38.5 | 42.7 |
| Доля ядра ≥ 5 докл., % | 24.0 | **31.9** | 32.3 |
| Индекс Джини | 0.461 | 0.470 | 0.510 |
| Удержание дебютантов, % | 56.3 | **61.5** | 57.3 |
| Медиана докл. на ученого | 2 | 2 | 2 |
| Максимум докл. у одного | 15 | 12 | 22 |
...
Зографские чтения дают 148 уникальных ученых и 484 авторских участия; доля ядра
составляет 25.7%, доля разовых участников — 39.9%, удержание дебютантов — 60.1%,
индекс Джини — 0.444. Поэтому включение предварительной программы 2026 г. усиливает
...
ученых (91 против 167), они показывают:

- **описательно более плотное ядро** (31.9% участников выступали пять и более раз
  против 24.0% в Зографе во всем корпусе; при отсечении 2026 г. — 31.9% против
  25.7%);
- **более высокое удержание дебютантов** (61.5% против 56.3% во всем корпусе;
  при отсечении 2026 г. — 61.5% против 60.1%): дебют на Рериховских чтениях чаще
  оборачивается продолжительным участием;
- **меньшую долю разовых участников** (38.5% против 43.7%).
...
по доле ядра (29/91 против 40/167) и по доле разовых участников (35/91 против 73/167)
...
Индекс Джини практически идентичен у обеих площадок (0.470 и 0.461), что свидетельствует
о схожем характере концентрации, но это сходство достигается разными способами:
в Зографских чтениях концентрация распределена среди более широкого круга (167 ученых),
а в Рериховских — внутри гораздо более компактной группы (91 ученый). Эту особенность
...
Высокие показатели лояльности и удержания участников на обеих площадках (удержание дебютантов 56.3% в Зографе и 61.5% в Рериховских чтениях) выглядят примечательно на фоне институционального контекста российской науки 2010–2020-х гг. Как показывает А. В. Гринев, в условиях доминирования наукометрического оценивания публикации в сборниках трудов и материалах отечественных конференций зачастую маргинализировались администрацией вузов, оцениваясь «жалким одним баллом» или вовсе не стимулируясь материально [Гринев, 2019, с. 998–999]. Устойчивость ядра исследуемых чтений свидетельствует о том, что они продолжают функционировать как значимые пространства реальной содержательной деятельности и научной социализации, сохраняя свою ценность для сообщества вопреки логике бюрократических индикаторов.
...
2. **Видеотрансляция** очных заседаний организаторами систематически не ведется.
   ...
   в нашей базе по фамилии докладчика и заголовку (нечеткое сравнение строк,
...
* Среди авторов, составляющих «ядро» (выступивших $\ge 5$ раз за исследуемый период), доля сериализованных докладов составила 2.6% (28 докладов из 1077).
* В группе «периферии» (менее 5 выступлений) доля таких докладов оказалась равна 5.7% (17 докладов из 300).
* Применение точного критерия Фишера указывает на статистически значимое различие между группами ($p = 0.0153$), но направление различия противоположно сильной версии гипотезы: относительная доля сериализованных докладов выше не у ядра, а у периферии. Таким образом, гипотеза о том, что представители «ядра» более склонны к искусственному дроблению своих тем для удержания позиций на конференциях, не подтверждается.

В то же время корреляционный анализ Спирмена выявил слабую, но статистически высокозначимую положительную связь между общим числом выступлений автора и абсолютным количеством его сериализованных докладов ($\rho = 0.276$, $p < 0.0001$). Это свидетельствует о том, что сериализация является устойчивой индивидуальной стратегией долгосрочного планирования работы у отдельных исследователей, а не массовым инструментом искусственного завышения публикационной активности.
...
стал одним из мостов между двумя площадками, но не единственным**. Среди 38 ученых,
...
Еще более показательна метрика «когортной выживаемости» авторов — доля участников, выступивших на конференциях как минимум в течение двух разных лет. Наш анализ выявил значительный разрыв в стабильности участия:
...
Для всех 220 уникальных ученых в нашей базе полностью установлен год рождения.^2^ На этом основании можно вычислить медианный возраст участников каждой конференции в год ее проведения на сплошном массиве данных, полностью исключив селективное смещение выборки.
...
ho = -0.19$ ($p = 0.0048$), а сравнение трех периодов по критерию Краскела-Уоллиса подтверждает значимость различий ($H = 7.836$, $p = 0.0199$). Таким образом, гипотеза о постепенном омоложении входа новых участников полностью подтверждается на репрезентативном массиве данных.
...
Анализ показал следующие результаты:
1. **Приток новых участников (newcomer rate).** Доля докладчиков, впервые выступающих на Зографских чтениях, в эру Василькова составляла 24.9% (194 дебютанта из 780 уникальных участнико-лет), а в эру Альбедиль — Иванова — 23.1% (27 из 117). Различие не является статистически значимым (критерий хи-квадрат, $p = 0.7603$), что указывает на преемственность в темпах обновления состава участников.
2. **Тематический дрейф по дисциплинам (L1).** Структурный профиль научных дисциплин при смене оргкомитета остался стабильным (критерий хи-квадрат, $p = 0.8463$). Соотношение между доминирующими филологическими, философскими и религиоведческими блоками не претерпело резких изменений.
3. **Дрейф хронологических периодов (L2).** Распределение докладов по исследуемым эпохам также не показывает статистически значимого перераспределения (критерий хи-квадрат, $p = 0.2619$). Описательно заметно снижение доли классического периода (с 37.6% в эру Василькова до 26.3% в эру Альбедиль — Иванова) и рост доли тем модерного периода (с 9.9% до 15.8%), но при текущем объеме двух переходных программ этот сюжет должен оставаться наблюдаемой тенденцией, а не доказанным сдвигом.

Таким образом, смена руководства конференцией не привела к регистрируемой смене кадровой политики, дисциплинарного фокуса или распределения хронологических периодов. Описательное снижение доли классического периода и рост модерна в двух переходных программах можно показывать как наблюдаемую тенденцию, но не как доказанный тематический сдвиг.

## 9. Перекрестная когорта: 38 ученых российской индологии

Из 220 ученых нашей базы **38 (17.3%) — это те, кто выступали на обеих площадках**.
...
центром. Полный список 38 ученых приведен в приложении А.
...
## 10. Дополнительные гипотезы: источники, видео и масштаб обобщения

После основной проверки Н1--Н10 корпус позволяет поставить еще несколько групп
гипотез, связанных не столько с численностью площадок, сколько с устройством
источниковой видимости, жанром доклада и масштабом научного обобщения. Их статус
различен: часть уже проверяется текущими таблицами, часть требует отдельного
биографического или институционального слоя данных и поэтому ниже фиксируется как
проверяемая, но пока не доказанная исследовательская программа. Сильные результаты
выделены как подтвержденные или предварительно подтвержденные; слабые оставлены как
направления дальнейшей проверки, чтобы не подменять статистику интерпретацией.

### 10.1. Источниковая видимость и медиаслой

**Н11. «Город вместо учреждения» является эффектом формата программы, а не прямым
признаком внеинституционального статуса участника.** Эта гипотеза подтверждается
сильнее всего. В 899 авторских участиях доля записей, где вместо учреждения указан
только город, резко различается между площадками: 94.7% для Зографских чтений
против 13.0% для Рериховских. Стратифицированная по годам проверка (метод
Кохрана--Мантеля--Хензеля) дает отношение шансов около 157 при $p \approx 8 \times
10^{-85}$ (см. приложение Г.4). Поэтому городская метка в программе не должна
автоматически читаться как место работы, тип учреждения или отсутствие институции:
прежде всего это редакционный стандарт публикации программы.

**Н12. Периферийное участие может быть чаще внеуниверситетским или
внеинституциональным, но текущий корпус сам по себе этого не доказывает.** Данные
уверенно показывают более низкую возвращаемость региональных участников: 36.1%
против примерно 59% у столичных групп. Однако из строки «Казань», «Калининград»,
«Пенза» или «Екатеринбург» нельзя вывести, работает ли участник в университете,
академическом институте, музее, школе, независимом исследовательском статусе или
иной организации. Следовательно, корректная формулировка Н12 такова: региональная
периферия демонстрирует более слабую когортную устойчивость, а гипотеза о ее
внеуниверситетском характере требует отдельного authority-слоя с ручной или внешней
верификацией занятости. Пенза в этом смысле должна рассматриваться как возможное
исключение и контрольный кейс, а не как вывод из одной городской метки.

**Н13. YouTube-покрытие является не нейтральным зеркалом корпуса, а смещенным слоем
публичной видимости.** В собранных плейлистах насчитывается 178 видеозаписей, из
которых 89 автоматически сопоставлены с докладами, 65 требуют ручной проверки и
24 относятся к пропускам или сессионным записям. На уровне базы прямые ссылки на
видео привязаны к 82 уникальным докладам (84 авторским карточкам). Это покрытие
сильно неравномерно: оно относится почти исключительно к Зографским чтениям,
концентрируется в отдельных годах (особенно 2020 и 2025 гг.) и заметно различается
по тематическим группам. Поэтому видеослой полезен для анализа открытости и
видимости, но не должен использоваться как репрезентативная выборка всего корпуса
без поправки на смещение публикации.

**Н14. Шкала Гумилева фиксирует преобладание микрокейсового уровня обобщения.**
Для навигации по докладам введена отдельная шкала уровня обобщения: G1 -- отдельный
текст, автор, источник, термин или локальный сюжет; G2 -- региональная традиция,
школа, жанр или длительная историко-культурная линия; G3 -- широкий
сравнительный, цивилизационный или методологический уровень. В интерфейсе
микросайта эти уровни показаны как L1--L3, но в статье они обозначаются G1--G3,
чтобы не смешивать их с тематическими кодами L1/L2/L4. По 895 уникальным докладам
распределение резко асимметрично: G1 -- 852 доклада, G2 -- 37, G3 -- 6. Тем самым
корпус в целом устроен как поле конкретных источниковедческих и текстологических
кейсов, а не как пространство регулярных макросравнительных обобщений.

**Н15. Классификация по заголовку в большинстве случаев устойчива, но видеоконтекст
обнаруживает границы автоматической разметки.** Для 89 сопоставленных видеозаписей
сравнение уровня Гумилева, назначенного только по названию доклада, с уровнем,
полученным с учетом названия видео, дает 76 совпадений и 13 расхождений, то есть
согласие около 85%. Это достаточный уровень для навигационной классификации и
первичной статистики, но не для жестких выводов о научном стиле отдельного автора
без просмотра записи и ручной верификации спорных случаев.

### 10.2. Дополнительные социальные и жанровые гипотезы

**Н16. Онлайн-формат 2020 г. расширил вход, но не создал устойчивую новую когорту.**
В 2020 г. в корпус вошли 16 дебютантов; к последующим годам вернулись 8 из них
(50.0%). Для дебютантов соседнего периода 2018--2019 и 2021--2022 гг. возвращаемость
составляет 20 из 35 (57.1%); различие незначимо ($p \approx 0.764$). Следовательно,
пандемийный и онлайн-контекст мог облегчить вход, но пока не выглядит механизмом
долговременного закрепления новых участников.

**Н17. Тематическая специализация сама по себе не повышает удержание участника.**
Первоначальная формулировка предполагала, что возвращаются прежде всего авторы с
устойчивой темой. Текущий срез скорее усложняет этот тезис: участники ядра имеют
больше тематических рубрик в абсолютном выражении (медиана 3 против 1 у не-ядра),
что частично связано с большим числом докладов, а среди повторных участников ядро
сохраняет более выраженный профиль доминирующей темы, но не становится тематически
однообразным. Поэтому Н17 следует считать не подтвержденной в простой форме: удержание
связано не с одной темой, а с сочетанием долговременной специализации и способности
переходить между близкими сюжетами.

**Н18. Перекрестные участники не являются универсалами, а переносят между площадками
собственные тематические траектории.** Для 38 участников обеих площадок медианная
косинусная близость тематических профилей между Зографом и Рерихом составляет около
0.79. При этом совпадение доминирующей крупной рубрики наблюдается не у всех, поскольку
часть ранних и зографских докладов попадает в широкую категорию «не классифицировано».
Гипотеза поэтому предварительно поддержана на уровне близости профилей, но нуждается
в проверке на более детальной тематической сетке.

**Н19. Рериховские чтения сильнее завязаны на институциональную преемственность,
а Зографские -- на персональную и городскую видимость.** Эта гипотеза объединяет
результаты Н11 и институционального раздела: Рериховские программы чаще показывают
организации, тогда как Зографские почти всегда публикуют город. Следовательно,
сравниваются не только две конференции, но и два режима публичного представления
академической принадлежности: институциональный и персонально-городской.

**Н20. Высокая доля микрокейсового уровня связана с низкой межавторской интеграцией
поля.** Более 99% докладов остаются индивидуальными, а 95.2% уникальных докладов
относятся к уровню G1. Прямая причинная связь между этими признаками не доказана:
и микрокейсовость, и индивидуальное авторство могут быть независимыми следствиями
гуманитарного жанра. Но вместе они задают проверяемую модель поля как совокупности
индивидуальных источниковедческих траекторий, а не коллективных исследовательских
программ.

**Н21. Ядро не обязательно более тематически закрыто, чем периферия.** На грубом
уровне ядро имеет больше тематических рубрик, потому что чаще выступает. При сравнении
только повторных участников ядро показывает не полную монотематичность, а устойчивое
возвращение к нескольким близким направлениям. Поэтому Н21 важна как корректирующая:
«ядро» нельзя автоматически отождествлять с тематической закрытостью; оно скорее
обладает большей емкостью и более длинной траекторией.

**Н22. Новички чаще входят через современные или колониальные сюжеты, но не через
прикладные темы.** На уровне авторских участий современные/колониальные темы
составляют 21.8% дебютных докладов против 15.8% повторных ($p \approx 0.0505$),
то есть эффект находится на границе значимости. Прикладные и методологические
доклады, напротив, не чаще встречаются у дебютантов (5.0% против 7.5%, $p \approx
0.222$). Поэтому Н22 подтверждается только в части современно-колониального входа,
но не как общий «прикладной» канал.

**Н23. Возможные гендерные различия в удержании и тематических нишах пока не
проверяются корректно.** В текущей базе нет надежного верифицированного поля пола
или гендера участника. Следовательно, эта гипотеза сохраняется как потенциально
важная для будущего исследования, но не включается в доказательную часть без
отдельного этически и источниковедчески аккуратного слоя разметки.

**Н24. Жанр заголовка меняется после 2020 г., но не как простой линейный рост длины.**
Медиана длины названия остается около 8 слов, однако после 2023 г. растет средняя
длина (до 10.3 слова) и доля названий с двоеточием (25.5%). При этом общий
монотонный тренд по годам неоднозначен. Поэтому корректная формулировка Н24: в
новейшем слое заметно усиливается объяснительный и подзаголовочный жанр названия,
но это не сводится к простому ежегодному удлинению всех заголовков.

**Н25. Видеоархив усиливает видимость технически доступных годов и слабо связан с
центральностью участника.** Прямые видеоссылки есть у 82 докладов; доля видео у
докладов ядра (9.0%) почти не отличается от не-ядра (9.5%), а у перекрестных
участников (8.2%) -- от одноплощадочных (9.8%). Значит YouTube-покрытие отражает
не столько статус автора, сколько год, режим записи и последующую публикацию
материалов.

### 10.3. Гумилевская шкала как ось масштаба обобщения

**Н26. Российская конференционная индология устроена как культура микрокейса.**
Это самый сильный результат гумилевской шкалы: из 895 уникальных докладов 852
(95.2%) относятся к G1, то есть к уровню отдельного текста, автора, источника,
термина или локального сюжета. G2 включает 37 докладов, G3 -- только 6. Поэтому
микрокейс в данном корпусе не маргинален, а является нормой жанра.

**Н27. «Мостовые» участники не являются макрообобщающими синтетиками.** У авторов
перекрестной когорты доля G2/G3 составляет лишь 2.3%, тогда как у участников,
видимых только на одной площадке, -- 6.5%; различие предварительно значимо
($p \approx 0.0037$). Это важный результат: посредники между площадками связывают
поле не за счет больших цивилизационных синтезов, а за счет устойчивых частных
специализаций.

**Н28. Зографские чтения чуть терпимее к обобщающим докладам, чем Рериховские,
но эффект слабый.** Доля G2/G3 на Зографе составляет 31 из 540 докладов (5.7%),
на Рериховских -- 12 из 355 (3.4%); точный тест дает $p \approx 0.113$. Это
направление различия согласуется с образом Зографа как более широкой площадки, но
пока не должно трактоваться как доказанный институциональный фильтр.

**Н29. Рост обобщающих докладов не является линейным историческим трендом.** Доля
G2/G3 по периодам меняется от 2.8% в 2004--2010 гг. до 4.0% в 2011--2017 гг.,
5.7% в 2018--2022 гг. и 4.7% в 2023--2026 гг. Есть умеренный всплеск в среднем
периоде, но нет устойчивого движения от микрокейсов к макросинтезу.

**Н30. Видеоархив усиливает видимость микрокейсов, а не синтетических докладов.**
Среди 82 докладов с прямыми видеоссылками 81 относится к G1, один -- к G2 и ни
один -- к G3. Это не доказывает, что синтетические доклады не записываются, но
показывает: доступный медиаслой почти полностью микрокейсовый и потому не является
хорошим источником для изучения макрообобщающих жанров.

**Н31. G3-доклады образуют редкий жанр программного или цивилизационного
высказывания.** В корпусе всего шесть G3-докладов: о моделях христианского и
индо-буддийского времени, мифологиях северных мунда, южноазиатско-африканских
связях, индийской эпистемической культуре и Западе, «фейковой индологии» и
цивилизационной демаркации Восток--Запад. Их следует анализировать качественно
как особый жанр «большой рамки», а не как статистически массовое явление.

**Н32. Ядро не производит больше макрообобщений, чем периферия.** У докладов,
связанных с авторами ядра, G2/G3 составляет 28 из 653 (4.3%), у периферии -- 15
из 242 (6.2%); различие незначимо ($p \approx 0.290$). Это не поддерживает
интуицию, что накопленный статус автоматически ведет к более широкому масштабу
обобщения.

**Н33. Дебютанты не входят через более узкие темы, чем повторные участники.** Среди
дебютных докладов G2/G3 составляет 10 из 174 (5.7%), среди повторных -- 33 из 721
(4.6%); различие незначимо ($p \approx 0.553$). Следовательно, микрокейсовость не
является особым входным барьером для новичков: она задает общий стиль поля.

**Н34. Дисциплины различаются по допустимому масштабу обобщения.** На текущей
крупной тематической сетке лингвистика/филология почти полностью микрокейсова
(G1 -- 124 из 125 докладов), тогда как история культуры и неклассифицированные
междисциплинарные сюжеты чаще дают G2. Литература содержит три из шести G3-докладов.
Эта гипотеза требует дальнейшей проверки на более детальных подрубриках, но уже
показывает, что масштаб обобщения зависит от дисциплинарного жанра.

**Н35. Обобщающие доклады допускаются прежде всего как голос старшего поколения,
особенно на уровне G3.** Для всех G2/G3 вместе возрастной эффект умеренный: медиана
возраста авторского участия составляет 50 лет против 45 лет у G1, а тест Манна--Уитни
дает лишь тенденцию ($p \approx 0.066$). Но для редкого уровня G3 картина сильнее:
медианный возраст автора -- 66 лет, 4 из 6 G3-докладов сделаны участниками старше
60 лет. Поэтому гипотеза формулируется так: широкое цивилизационное обобщение не
запрещено полностью, но в наблюдаемом корпусе оно появляется главным образом как
жанр признанного старшего или уже авторитетного голоса, тогда как базовой нормой
для поля остается микрокейс.

Таким образом, Н11--Н35 расширяют основную аргументацию статьи в сторону критики
источника и жанра. Они показывают, что корпус содержит не только данные о людях и
темах, но и следы разных режимов публичной репрезентации: программы по-разному
показывают аффилиации, видеозаписи неравномерно распределяют видимость, микрокейсы
являются нормативным форматом доклада, а редкие обобщения чаще связаны с особым
статусом, дисциплиной и поколенческой позицией автора.

## 11. Заключение

Главные выводы настоящего исследования можно резюмировать в двадцати пунктах.
...
2. **Метрики закрытости описательно поддерживают это различие**: доля ядра в
   Рериховских чтениях выше на 6.2–7.9 процентного пункта в зависимости от включения
   предварительной программы 2026 г.; удержание дебютантов выше на 1.4–5.2 пункта;
...
10. **Смена оргкомитета Зографских чтений при переходе к периоду 2025–2026 гг. пока не показывает статистически значимого изменения кадровой или тематической политики.** Приток новых авторов ($p = 0.7603$), дисциплинарная структура L1 ($p = 0.8463$) и распределение периодов L2 ($p = 0.2619$) значимых изменений не претерпели. Описательное снижение доли классического периода с 37.6% до 26.3% требует наблюдения на следующих программах, поскольку текущий переходный срез слишком короток.
11. **«Сериализация» докладов (практика salami slicing) не выступает доминирующей стратегией участников.** Доля сериализованных докладов крайне низка; при этом относительная доля у периферии выше, чем у ядра (5.7% против 2.6%, $p = 0.0153$), что опровергает сильную версию гипотезы о большей склонности ядра к дроблению тем. Обнаруженная слабая корреляция между числом выступлений автора и количеством его сериализованных работ ($\rho = 0.276, p < 0.0001$) указывает на то, что это скорее индивидуальный исследовательский стиль долгосрочного ведения крупных тем, нежели тактика искусственного завышения активности.
12. **«Город вместо учреждения» является прежде всего источниковедческим эффектом.** Различие между Зографскими и Рериховскими чтениями по доле записей только с городом слишком велико и устойчиво, чтобы читать его как прямое свидетельство биографической внеинституциональности участников. Оно отражает разные стандарты публикации программ.
13. **Гипотеза о внеуниверситетском характере периферии требует отдельной проверки.** Корпус подтверждает более низкую возвращаемость региональных участников, но не позволяет автоматически установить тип их занятости. Поэтому тезис о периферийных неуниверситетских траекториях должен проверяться через authority-слой; Пенза выступает здесь не доказательством, а важным контрольным случаем.
14. **YouTube-слой расширяет публичную проверяемость, но вносит смещение видимости.** 178 собранных видеозаписей и 82 напрямую привязанных к базе доклада полезны для проверки отдельных случаев, однако их распределение по годам, площадкам и темам не репрезентативно для всего корпуса.
15. **Шкала Гумилева показывает преобладание микрокейсового уровня.** Из 895 уникальных докладов 852 отнесены к уровню конкретного текста, автора, источника или локального сюжета; только 37 выходят на региональный уровень и 6 -- на широкий сравнительный или методологический уровень. Это подтверждает текстоцентричный и кейсоцентричный характер поля.
16. **Сопоставление заголовков с видеоконтекстом задает границу автоматической классификации.** В 76 из 89 сопоставленных видеослучаев уровень обобщения совпадает, но 13 расхождений показывают, что навигационная разметка не должна подменять ручную экспертную интерпретацию спорных докладов.
17. **Онлайн-эпизод 2020 г. не создал отдельной устойчивой когорты.** Возвращаемость дебютантов 2020 г. не выше, чем у соседних лет; это поддерживает вывод о том, что долговременное включение в поле определяется не только технической доступностью участия.
18. **Ядро и перекрестная когорта не являются автоматическими носителями макрообобщения.** Наоборот, перекрестные участники чаще удерживают частные специализации, а доля G2/G3 у них ниже, чем у одноплощадочных участников. Мостовая функция поля обеспечивается не большими синтезами, а устойчивостью личных исследовательских траекторий.
19. **Гумилевская шкала задает отдельную ось анализа, не сводимую к тематическим кодам.** Она показывает не «о чем» доклад, а на каком масштабе он говорит: микрокейс, региональная традиция или широкое сравнение. В этом смысле она выявляет жанровую норму поля лучше, чем обычная дисциплинарная рубрика.
20. **Широкое обобщение остается редким и поколенчески маркированным жанром.** G3 почти не встречается и чаще принадлежит старшим или уже авторитетным участникам. Поэтому микрокейс не просто допустим, а фактически приветствуется как нормальный формат выступления, тогда как большое обобщение оказывается исключительным правом особого голоса.

Демографически обе площадки демонстрируют не простое монотонное старение, а более
сложную задачу воспроизводства состава. Сплошная биографическая верификация показывает,
что возраст первого наблюдаемого выступления снижается по сравнению с ранним периодом,
а в 2025 г. обе площадки сходятся на медианном возрасте участников 47.5 лет. Поэтому
главное напряжение состоит не в механическом отсутствии молодых кадров, а в том, что
новые участники и региональная периферия слабее закрепляются в устойчивой когорте.
В обозримой перспективе обе сегодняшние модели институционализации (плотное ядро
ИВ РАН в Москве и более диффузная межинституциональная сеть в Петербурге) будут
испытаны на прочность задачей привлечения и удержания новых поколений.
...
^1^ Примеры посвященных В. А. Новиковой, Д. Д. Елисееву и другим историкам русской индологии докладов приведены из программы XLVII Зографских чтений (май 2026 г.).

^2^ Мы провели сплошную архивную и просопографическую верификацию биографических данных для всей когорты из 220 ученых. Использование оценочных прокси-метрик по внешним базам вроде OpenAlex не потребовалось, что позволило полностью исключить селективное смещение выборки.
...
10. *Гринев А. В.* Использование наукометрических показателей при оценке публикационной активности в современной России // Вестник Российской академии наук. 2019. Т. 89, № 10. С. 993–1002. DOI: https://doi.org/10.31857/S0869-58738910993-1002

---

## Приложение А. Перекрестная когорта: 38 ученых российской индологии

Полный список ученых, выступавших и на Зографских, и на Рериховских чтениях за период 2004–2026 гг., упорядочен по убыванию суммарного числа докладов. Столбец «годы» — первый и последний доклад в нашей выборке; столбец «г. р.» — год рождения; «†» — год смерти, где зафиксирован.

| 1 | С. О. Цветкова | 1978 | — | 22 | 10 | 12 | 2007–2026 | Санкт-Петербург |
| 2 | Н. В. Александрова | 1965 | — | 20 | 9 | 11 | 2012–2026 | Москва |
| 3 | С. С. Тавастшерна | 1969 | — | 20 | 8 | 12 | 2006–2026 | Санкт-Петербург |
| 4 | С. И. Рыжакова | 1970 | — | 19 | 15 | 4 | 2004–2026 | Москва |
| 5 | В. Г. Лысенко | 1953 | — | 16 | 12 | 4 | 2004–2025 | Москва |
| 6 | Н. А. Корнеева | 1972 | — | 15 | 10 | 5 | 2010–2026 | Москва |
| 7 | А. Г. Мехакян | 1978 | — | 15 | 3 | 12 | 2007–2025 | ММС |
| 8 | А. М. Дубянский | 1941 | 2020 | 14 | 7 | 7 | 2004–2020 | Москва |
| 9 | В. В. Вертоградова | 1933 | — | 13 | 1 | 12 | 2006–2024 | ИВ РАН |
| 10 | О. П. Вечерина | 1960 | 2023 | 13 | 6 | 7 | 2014–2022 | Москва |
| 11 | Н. Р. Лидова | 1954 | — | 13 | 6 | 7 | 2010–2026 | Москва |
| 12 | Ю. М. Алиханова | 1936 | 2024 | 11 | 5 | 6 | 2004–2019 | ИСАА МГУ |
| 13 | А. Н. Бабин | 1990 | — | 10 | 4 | 6 | 2017–2025 | Москва |
| 14 | Д. Н. Воробьева | 1982 | — | 10 | 2 | 8 | 2015–2025 | Москва |
| 15 | Д. И. Жутаев | 1969 | 2020 | 10 | 2 | 8 | 2006–2019 | ИВ РАН |
| 16 | Е. А. Юдицкая | 1987 | — | 10 | 3 | 7 | 2012–2022 | ИВ РАН |
| 17 | Н. В. Гордийчук | 1982 | — | 9 | 4 | 5 | 2016–2022 | Москва |
| 18 | Е. Д. Огнева | 1944 | — | 9 | 1 | 8 | 2012–2022 | ИВ НАН Украины |
| 19 | А. Г. Гурия | 1988 | — | 8 | 1 | 7 | 2007–2024 | ИСАА МГУ, онлайн |
| 20 | А. С. Крылова | 1985 | — | 7 | 4 | 3 | 2020–2026 | Москва |
| 21 | Е. О. Кузина | 1991 | — | 7 | 2 | 5 | 2016–2022 | ГИИ |
| 22 | Л. И. Куликов | 1964 | — | 7 | 4 | 3 | 2018–2026 | Гент |
| 23 | А. А. Смирнитская | 1978 | — | 7 | 5 | 2 | 2018–2025 | Москва |
| 24 | Л. И. Титлин | 1986 | — | 7 | 3 | 4 | 2012–2022 | ИФ РАН |
| 25 | Е. А. Уланский | 1981 | — | 7 | 4 | 3 | 2019–2025 | независимый исследователь |
| 26 | А. В. Ложкина | 1992 | — | 6 | 1 | 5 | 2015–2019 | ИФ РАН |
| 27 | М. Ю. Гасунс | 1983 | — | 6 | 4 | 2 | 2006–2024 | ни |
| 28 | Д. Н. Лелюхин | 1956 | 2014 | 6 | 5 | 1 | 2004–2014 | Москва |
| 29 | Н. А. Канаева | 1953 | — | 6 | 3 | 3 | 2013–2025 | Москва |
| 30 | А. А. Вигасин | 1946 | — | 5 | 3 | 2 | 2006–2025 | Москва |
| 31 | Д. А. Комиссаров | 1977 | — | 5 | 4 | 1 | 2018–2026 | Москва |
| 32 | Е. А. Ренковская | 1991 | — | 5 | 4 | 1 | 2020–2026 | Москва |
| 33 | В. К. Шохин | 1951 | — | 5 | 3 | 2 | 2020–2026 | Москва |
| 34 | Р. Н. Крапивина | 1953 | — | 4 | 3 | 1 | 2011–2026 | Санкт-Петербург |
| 35 | М. Д. Минаева | 1999 | — | 3 | 1 | 2 | 2024–2026 | Москва |
| 36 | А. В. Молина | 1999 | — | 3 | 1 | 2 | 2024–2026 | Москва |
| 37 | С. В. Кулланда | 1954 | 2020 | 2 | 1 | 1 | 2011–2012 | ИВ РАН |
| 38 | А. В. Фивейская | 1993 | — | 2 | 1 | 1 | 2020–2021 | Москва |

Среди 38 ученых год рождения известен для 17.
...
российских и зарубежных учреждений. По частоте появления среди 38 — ИВ РАН, СПбГУ,
...
Нижеприведенная таблица содержит выборку из 30 докладов, отобранных следующим образом: (1) уровень уверенности кодирования ≥ 0,8; (2) сбалансированное распределение по четырем доминирующим дисциплинам (религиоведение, литературоведение, философия, лингвистика), составляющим 75,0% выборки; (3) равномерное представление обеих серий конференций; (4) сортировка по году и названию для обозрения.
...
| 28 | 2025 | Рерих | Анаттавада «палийского Будды» в ее философских и сотериологических координатах | философия | классический | текст | фундаментальный |
...
Как видно из выборки, фундаментальный характер исследований преобладает во всех дисциплинах (29 из 30 примеров). Классический период также доминирует, хотя представлены все основные периоды: ведийский, классический, средневековый, колониальный и новое время. Текстуальный анализ остается основным методологическим подходом (93% примеров), с редкими случаями использования архивных источников, артефактов и полевого материала. Полный список из 895 кодированных докладов передан в редакцию как supplementary_theme_codes.csv.
...
проверки, на которые эти формулировки опираются. Все расчеты воспроизводимы из базы
...
Из 220 ученых 38 (17.3%) выступали на обеих площадках. Само по себе это число ничего
не говорит о замкнутости: при большом числе докладов многие ученые пересекли бы границу
...
ученому, но метка площадки случайно перераспределяется по всем участиям 20 000 раз.
Тем самым сохраняются и общее число участий каждого ученого, и общий объем каждой
площадки; меняется лишь то, на какую площадку «попадает» конкретное участие. Для каждой
перестановки подсчитывается, сколько ученых оказались бы на обеих площадках.

Результат однозначен. При случайном распределении той же активности на обеих площадках
ожидаемо оказались бы около **104 ученых** (среднее 103,6, стандартное отклонение 3,5).
Фактически на обеих площадках выступали лишь **38**. Наблюдаемое пересечение более чем
на восемнадцать стандартных отклонений ниже ожидаемого (z ≈ −18,3; p < 0,0001, причем
ни одна из 20 000 случайных перестановок не дала пересечения столь же малого, как
наблюдаемое).

![Рис. Г1. Нулевое распределение числа ученых на обеих площадках](hypothesis_output/null_model_overlap.svg)

Это и есть формальное основание для тезиса о **двух частично изолированных средах**:
ученые распределяются между Зографскими и Рериховскими чтениями значительно более
обособленно, чем предсказывает уровень их активности. Пересечение в 38 человек — не
...
Шесть метрик раздела 4 — точечные оценки по конечной и неравной по объему выборке,
поэтому к каждой относится неопределенность. Мы оцениваем ее непараметрическим
бутстрепом (10 000 повторных выборок ученых с возвращением); в скобках приведен
...
|---|---|---|
| Доля разовых участников, % | 43,7 (36,5–50,9) | 38,5 (28,6–48,4) |
| Удержание дебютантов, % | 56,3 (48,5–64,1) | 61,5 (51,7–71,4) |
| Доля ядра ≥ 5 докл., % | 24,0 (17,4–30,5) | 31,9 (23,1–41,8) |
| Индекс Джини | 0,46 (0,43–0,49) | 0,47 (0,43–0,50) |
...
|---|---:|:---:|:---:|
| Доля ядра ≥ 5 | +7,8 | (−3,7; +19,3) | нет (p ≈ 0,18) |
| Удержание дебютантов | +5,2 | (−7,3; +17,4) | нет (p ≈ 0,41) |
| Доля разовых участников | −5,3 | (−17,8; +7,4) | нет (p ≈ 0,40) |
| Индекс Джини | +0,01 | (−0,04; +0,05) | нет (p ≈ 0,72) |
...
в «закрытости»: при нынешнем объеме данных эти различия по отдельным метрикам не
...
Тезис о том, что дебютанты одной площадки «дольше остаются в строю», требует учета
**цензурирования**: для ученых, впервые или в последний раз появившихся недавно, мы
еще не знаем, продолжится ли их участие. Мы строим оценку дожития Каплана—Мейера, где
«временем жизни» считается число лет от первого до последнего выступления ученого на
...
| Площадка | Ученых | Наблюдаемых «уходов» | Медианная длительность, лет |
|---|---:|---:|---:|
| Зограф | 167 | 87 | 8 |
| Рерих | 91 | 43 | 7 |

![Рис. Г2. Кривые дожития: доля ученых, еще активных через N лет после дебюта](hypothesis_output/km_retention.svg)

Различие между кривыми **статистически незначимо** (логранговый критерий χ² ≈ 0,001,
p ≈ 0,988). Более того, медианная длительность участия на Зографских чтениях не ниже,
...
конкретных ученых. Мы классифицируем каждое из 899 участий как «только город / без
...
Различие огромно и устойчиво при учете года (метод Кохрана—Мантеля—Хензеля со
