...
> Рабочий драфт для ППВ. Версия 0.5, 2026-05-21. Целевой объем 12–15 стр., итоговое
...
Статья представляет ретроспективный количественный анализ двух старейших публично
...
![Рис. 3. Возраст первого выступления в корпусе](hypothesis_output/age_at_debut.svg)
...
![Рис. 6. Сетевые посредники по совместным сессиям](hypothesis_output/network_bridges_session.svg)

Сетевой расчет уточняет этот вывод. Если строить граф по совместному участию в одном
...
снижает эту проблему и выводит в верх списка посредничества С. И. Рыжакову,
...
Главные выводы настоящего исследования можно резюмировать в семи пунктах.
