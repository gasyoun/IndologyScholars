...
> дополнительные гипотезы Н11--Н15.
...
После основной проверки Н1--Н10 корпус позволяет поставить еще пять гипотез,
связанных не столько с численностью площадок, сколько с устройством источниковой
видимости. Их статус различен: часть уже проверяется текущими таблицами, часть
требует отдельного биографического слоя данных и поэтому ниже фиксируется как
проверяемая, но пока не доказанная исследовательская программа.
...
Таким образом, Н11--Н15 расширяют основную аргументацию статьи в сторону критики
источника. Они показывают, что корпус содержит не только данные о людях и темах,
но и следы разных режимов публичной репрезентации: программы по-разному показывают
аффилиации, видеозаписи неравномерно распределяют видимость, а масштаб обобщения
доклада зависит от того, читаем ли мы только заголовок или сопоставляем его с
медиаконтекстом.

## 11. Заключение

Главные выводы настоящего исследования можно резюмировать в шестнадцати пунктах.
