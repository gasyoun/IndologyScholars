...
- Тест тренда: Spearman ρ=-0.153, p=0.2205; Kruskal-Wallis H=0.578, p=0.7489.
...
- Доля новичков (newcomer rate): эра Василькова (<=2024) — 32.9% (141/428), эра Альбедиль-Иванова (2025-2026) — 25.9% (30/116). Тест хи-квадрат: p=0.1788.
...
- Выживаемость (доля участников с выступлением в >= 2 годах): Москва — 59.5%, СПб — 58.1%, Регионы/Ино — 36.1%. Тест хи-квадрат (столица vs регионы): p=0.0191.
...
- Доля сериализованных докладов у ядра (>=5 выступлений): 2.2% (14/647)
- Доля сериализованных докладов у периферии (<5 выступлений): 4.0% (10/252)
- Точный критерий Фишера (различие долей): p=0.1649
- Корреляция Спирмена (число докладов vs число сериализованных докладов): rho=0.223, p=0.0007
