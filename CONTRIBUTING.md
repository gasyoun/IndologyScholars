...
# Contributing to IndologyScholars
...
See [`CLAUDE.md`](https://github.com/gasyoun/IndologyScholars/blob/main/CLAUDE.md) for repo-specific commands and conventions.
