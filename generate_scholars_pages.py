...
def profile_structured_data(scholar, authority):
    ...
    if is_public_authority_record(person_authority):
        ...
        for key in ("orcid", "wikidata", "viaf", "openalex", "wikipedia", "google_scholar", "official_url", "vk", "scopus_author_id", "researcher_id", "rinc_author_id", "samskrtam_ru"):
...
def render_profile(scholar, related, authority, meso_by_presentation, meso_items):
    ...
    body = template.render(
        ...
        show_affiliation_transparency=scholar.get("show_affiliation_transparency", False),
        affiliation_coverage_pct=scholar.get("affiliation_coverage_pct", 100.0),
