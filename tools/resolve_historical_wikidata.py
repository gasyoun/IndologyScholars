...
ROSTER = [
    ...
    # Транш 27-40 (H5389 What-is-left item, roadmap Фаза 2-продолжение). Sourced via
    # Wikidata SPARQL: occupation=indologist(Q18524037)/tibetologist(Q1864603)/
    # buddhologist(Q100851212) OR field-of-work=Sanskrit(Q11059)/Indology(Q625510),
    # citizenship in {Russian Empire, Russia, USSR, Ukrainian SSR}, birth_year<1918.
    # Every QID below checked by hand against label+description+occupation before
    # pinning, same discipline as the original ROSTER (see module docstring).
    ("Маевский", "Викентий", "", "Q4274387", ""),
    ("Болензен", "Фёдор", "Фёдорович", "Q15064592", ""),
    ("Шифнер", "Антон", "Антонович", "Q551620", ""),
    ("Кудрявский", "Дмитрий", "Николаевич", "Q4244571", ""),
    ("Кнауэр", "Фёдор", "Иванович", "Q61312775", ""),
    ("Шрёдер", "Леопольд", "фон", "Q70798", ""),
    ("Цыбиков", "Гомбожаб", "Цэбекович", "Q1255243", ""),
    ("Розенберг", "Оттон", "Оттонович", "Q4396532", ""),
    ("Калинович", "Михаил", "Яковлевич", "Q12107798", ""),
    ("Дьяков", "Алексей", "Михайлович", "Q17619573", ""),
    ("Клягина-Кондратьева", "Мелитина", "Ивановна", "Q114036874", ""),
    ("Бескровный", "Василий", "Матвеевич", "Q4085641", ""),
    ("Дандарон", "Бидия", "Дандарович", "Q1968548", ""),
    ("Ильин", "Григорий", "Фёдорович", "Q109485806", ""),
]
