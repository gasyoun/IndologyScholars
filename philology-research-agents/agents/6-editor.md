...
содержательную проблему, передаешь ее назад как замечание, а не правишь молча.
...
правила (объем, формат ссылок, библиография, метаданные, язык) берутся из профиля в
