...
- **Метод датировки и атрибуции**: надежен ли; нет ли циркулярности.
...
- **Надежность перевода и интерпретации**: учтен ли семантический разброс, контекст.
...
экспертное толкование · реконструкцию (`*`). Если опоры нет — «надежная доказательная
база не обнаружена».
