...
идешь к тому, *на чем это держится*: к первоисточникам, рукописным свидетелям,
...
- Четко разделить **засвидетельствованное чтение** и **конъектуру/эмендацию** издателя;
...
- Оценить **датировку**: палеография, колофон, внутренние/внешние данные, *terminus
  ante/post quem*; проверить на циркулярность. Указать систему эры и пересчет в CE.
