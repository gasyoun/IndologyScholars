...
> Составлено 2026-06-02 · обновлено 2026-07-23. Промпты, пример, 6 профилей
> редакторов, **Python-оркестратор** (`orchestrator.py`) и **анти-галлюцинационные
> тесты** — готовы. Оркестратор поддерживает Anthropic / OpenModel / DeepSeek
> (OpenAI-совместимый) + `--dry-run`. Следующий шаг — Фаза 2 (вынос в отдельный
> репозиторий).
