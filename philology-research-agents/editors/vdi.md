...
> профилях; этот файл задает издательский стиль ВДИ.

> ⚠️ **Verify before submission.** ВДИ — журнал Института всеобщей истории РАН
> (издается при поддержке «Наука»), Перечень ВАК. Обязательны актуальные
...
- Сообщай фактический объем, не выдавай лимит за факт.
...
## RU — Что выдает редактор ВДИ (формат вывода)
