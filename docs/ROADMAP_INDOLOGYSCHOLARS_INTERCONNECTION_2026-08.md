# Roadmap — IndologyScholars interconnection, 2026-08

_Created: 26-08-2026 · Last updated: 26-08-2026_

Index: [PLAN_INDOLOGYSCHOLARS_INTERCONNECTION_2026-08.md](https://github.com/gasyoun/IndologyScholars/blob/main/docs/PLAN_INDOLOGYSCHOLARS_INTERCONNECTION_2026-08.md).
...
## Wave 1 — IndologyScholars's wiring change

- [ ] [H3567 (Opus 5)](https://github.com/gasyoun/Uprava/blob/main/handoffs/H3567-Opus_IndologyScholars_interconnect-indology-crosswalk-feed-edge_26.08.26.md) · medium
...
For IndologyScholars specifically: wiring score at or above **60** (or a written reason it
