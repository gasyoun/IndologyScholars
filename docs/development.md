...
`site_data.json`. На 25 мая 2026 г. он содержит 286 профилей докладчиков,
...
Зографских чтений - 180, только Рериховских - 65.
...
| [../architecture.md](../architecture.md) | Исторический архитектурный план. |
| [../architecture_implementation_plan.md](../architecture_implementation_plan.md) | Запись выполненного усиления архитектуры. |

Файлы `CHANGELOG.md`, `HANDOFF.md`, `.ai_state.md` и материалы `article/`
служат журналом или исследовательскими снимками; содержащиеся в них числа
нужно читать в контексте указанной даты.
