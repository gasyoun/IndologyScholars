...
`site_data.json`. На 23 июля 2026 г. он содержит 268 профилей докладчиков,
...
Зографских чтений - 163, только Рериховских - 64. Отдельный исторический
просопографический слой (26 фигур, `person_kind = historical`) **не** входит
в счётчик докладчиков.
...
Спутники корпуса (не входят в основную сборочную цепочку конференций выше):

| Путь | Роль |
| --- | --- |
| [`nagari/`](https://github.com/gasyoun/IndologyScholars/tree/main/nagari) | Архив закрытой гуглгруппы + Pages-ретроспектива. |
| [`vk-ors/`](https://github.com/gasyoun/IndologyScholars/tree/main/vk-ors) | Экспорт VK-стены → SQLite+FTS5 + четыре слоя анализа. |
| [`sources/vigasin/`](https://github.com/gasyoun/IndologyScholars/tree/main/sources/vigasin) | Сырые полные тексты Вигасина (ещё не в генераторе страниц учёных). |
| [`gasyoun/IndologyArchiveAtlas`](https://github.com/gasyoun/IndologyArchiveAtlas) | Выделенный атлас INDOLOGY-L; здесь — feed + redirect. |
