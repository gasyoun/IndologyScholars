...
_Created: 08-08-2026 · Last updated: 05-09-2026_
...
Make geographic mobility **recomputable** and surface gravity + retention tables on [`findings/mobility.html`](https://github.com/gasyoun/IndologyScholars/blob/main/findings/mobility.html) — without inventing moves. City labels come only from programme affiliation text.
...
Page: [`findings/mobility.html`](https://github.com/gasyoun/IndologyScholars/blob/main/findings/mobility.html).
