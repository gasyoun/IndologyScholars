...
SEO-E step 1 — gzip-precompile site_data.json (1.5 MB → ~400 KB) + search-index.json, plus <link rel="preload"> for above-fold data. Single afternoon, biggest perf lift for Yandex PF
