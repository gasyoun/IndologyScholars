...
MESO_LABELS = {
    "tibetology_himalaya": "Тибетология / гималайский контур",
    "dravidology_south_india": "Дравидология / южноиндийский контур",
    ...
    "roerich_studies": "Рериховедение",
    "china_mongolia_inner_asia": "Китай, Монголия и Центральная Азия",
    "ethnography_performance": "Этнография, ритуал и перформанс",
    "epic_ramayana_mahabharata": "Эпосы: Рамаяна и Махабхарата",
    "buddhist_studies": "Буддийские традиции",
    "philosophy_epistemology": "Философия и эпистемология",
    "bhakti_vaishnava": "Бхакти и вайшнавизм",
    "jain_studies": "Джайнизм",
    "sikh_studies": "Сикхские исследования",
    "translation_reception": "Перевод и рецепция",
    "manuscripts_epigraphy": "Рукописи и эпиграфика",
    "visual_material_culture": "Визуальная и материальная культура",
    "colonial_encounters": "Колониальные контакты и путешествия",
    "modern_society_politics": "Современное общество и политика",
    "yoga_ayurveda": "Йога и Аюрведа",
